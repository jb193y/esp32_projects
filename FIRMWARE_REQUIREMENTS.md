...
4. **Upload Firmware Code**:
   ```bash
    mpremote connect port:COM12 cp vc/boot.py :boot.py + cp vc/config.defaults.json :config.defaults.json + cp vc/config.json :config.json + cp vc/main.py :main.py + cp lib/config.py :lib/config.py + cp lib/led_status.py :lib/led_status.py + cp lib/ble_manager.py :lib/ble_manager.py + cp lib/espnow_client.py :lib/espnow_client.py + cp lib/espnow_relay.py :lib/espnow_relay.py + cp lib/factory_reset.py :lib/factory_reset.py
   ```
